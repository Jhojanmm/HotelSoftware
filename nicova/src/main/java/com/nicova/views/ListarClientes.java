...
public class ListarClientes extends javax.swing.JPanel {
    ...
    public ListarClientes() {
        ...
        jtableCliente.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                Object selectHabitacion = jtableCliente.getValueAt(selectedRow, 1);
    ...
    private void setModelo() {
        String[] cabeceras = {"#", "Documento", "Nombre", "Correo"};
    ...
    private void setDatos() {
        ...
        int i = 0;
        for (Cliente custom : listaCliente) {
            if (i != 0) {
                datos[0] = i;
                datos[1] = custom.getDocumento();
                datos[2] = custom.getNombre();
                datos[3] = custom.GetCorreo();
                i++;
